...
const FACT_ACTOR$1 = "deliverables";
...
//#endregion
export { AttentionError, AttentionItemId, AttentionService, BUGFIX_RECIPE_ID, BUGFIX_TEMPLATE, CODE_REVIEW_RECIPE_ID, CODE_REVIEW_TEMPLATE, DeliverableError, DeliverableId, DeliverableService, DeliverableVersionId, EMPTY_TEMPLATE, EMPTY_TEMPLATE_RECIPE_ID, ImpactSnapshotId, JOURNAL_SEQ_KEY_WIDTH, JournalError, JournalEventId, PhaseRunId, REQUIREMENT_RECIPE_ID, REQUIREMENT_TEMPLATE, RecipeError, RecipeId, RecipeRegistry, RecipeRegistry as default, ReviewPolicyError, ReviewPolicyRecordId, ReviewPolicyService, SubmissionId, TASK_SEED_FACT_KIND, TaskError, TaskHandle, TaskId, TaskRunId, WorkbenchJournalService, acceptSubmission, attentionDomainSpec, attentionItemSchema, breakerCounterSchema, canCompleteTask, deliverableLocalDomainSpec, deliverableVersionSchema, hashRecipePayload, itemKeySchema, journalFactSchema, journalSeqKey, phaseInputsSchema, phaseTransition, reviewPolicyDomainSpec, reviewPolicyRecordSchema, taskTransition, validateRecipePayload, verifyRecipeHash, workbenchJournalDomainSpec };
