...
let RecipeRegistry = (() => {
	...
	return class RecipeRegistry extends _classSuper {
		...
		constructor(ctx) {
			super(ctx, "recipes");
			this.revisions = (__runInitializers$13(this, _instanceExtraInitializers), /* @__PURE__ */ new Map());
...
let TaskHandle = (() => {
	...
	return class TaskHandle extends _classSuper {
		...
		constructor(ctx) {
			...
			this.writeTail = (__runInitializers$12(this, _instanceExtraInitializers), Promise.resolve());
	...
	return class WorkbenchJournalService extends _classSuper {
		...
		*/
		constructor(ctx) {
			...
			this.entries = __runInitializers$11(this, _instanceExtraInitializers);
...
let AttentionService = (() => {
	...
	return class AttentionService extends _classSuper {
		...
		*/
		constructor(ctx) {
			super(ctx, "attention");
			this.items = __runInitializers$10(this, _instanceExtraInitializers);
	...
	return class DeliverableService extends _classSuper {
		...
		*/
		constructor(ctx) {
			...
			this.versions = __runInitializers$9(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
		}
	...
	return class ReviewPolicyService extends _classSuper {
		...
		*/
		constructor(ctx) {
			...
			this.tiers = __runInitializers$8(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
	...
	return class ClarificationService extends _classSuper {
		...
		*/
		constructor(ctx) {
			...
			this.requests = __runInitializers$7(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
		}
	...
	return class RewindService extends _classSuper {
		...
		*/
		constructor(ctx) {
			super(ctx, "rewind");
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = (__runInitializers$6(this, _instanceExtraInitializers), Promise.resolve());
		}
		/**
...
let BudgetService = (() => {
	...
	return class BudgetService extends _classSuper {
		...
		*/
		constructor(ctx) {
			super(ctx, "budget");
			this.records = __runInitializers$5(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
		}
