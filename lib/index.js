...
//#endregion
//#region lib/types/recipe/spec.js
/**
...
const idString$2 = z.string().min(1);
...
const p4ModeSpec = z.object({ mode: z.enum([
	"auto",
	"draft",
	"skeleton",
	"verify-normalize"
...
const recipeRevisionSchema = z.object({
	recipeId: idString$2,
...
const recipeStoreDomainSpec = defineDomain({
	name: "recipe_store",
	version: 1,
	tables: {
		recipes: domainTable(recipeRevisionSchema),
		recipe_meta: domainTable(recipeMetaSchema)
	}
});
//#endregion
...
let RecipeRegistry = (() => {
	...
	return class RecipeRegistry extends _classSuper {
		static {
			...
			__esDecorate$15(this, null, _register_decorators, {
				kind: "method",
				name: "register",
				static: false,
				private: false,
			...
			__esDecorate$15(this, null, _createRecipe_decorators, {
				kind: "method",
				name: "createRecipe",
				static: false,
				private: false,
				access: {
					has: (obj) => "createRecipe" in obj,
					get: (obj) => obj.createRecipe
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate$15(this, null, _updateRecipe_decorators, {
				kind: "method",
				name: "updateRecipe",
				static: false,
				private: false,
				access: {
					has: (obj) => "updateRecipe" in obj,
					get: (obj) => obj.updateRecipe
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate$15(this, null, _deleteRecipe_decorators, {
				kind: "method",
				name: "deleteRecipe",
				static: false,
				private: false,
				access: {
					has: (obj) => "deleteRecipe" in obj,
					get: (obj) => obj.deleteRecipe
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate$15(this, null, _getPinned_decorators, {
				kind: "method",
				name: "getPinned",
				static: false,
				private: false,
			...
			__esDecorate$15(this, null, _latest_decorators, {
				kind: "method",
				name: "latest",
				static: false,
				private: false,
			...
			__esDecorate$15(this, null, _list_decorators, {
				kind: "method",
				name: "list",
				static: false,
				private: false,
			...
			__esDecorate$15(this, null, _listDetails_decorators, {
				kind: "method",
				name: "listDetails",
				static: false,
				private: false,
		...
		constructor(ctx) {
			super(ctx, "recipes");
			this.revisions = (__runInitializers$15(this, _instanceExtraInitializers), /* @__PURE__ */ new Map());
		...
		*/
		async [Service.init]() {
			...
			if (facility !== void 0) try {
				...
				this.revisionsTable = void 0;
				this.metaTable = void 0;
			}
		}
		/** Reconcile in-memory registry with the durable store. */
		loadFromStorage() {
			if (this.revisionsTable !== void 0) for (const [, revision] of this.revisionsTable.entries()) this.revisions.set(recipeKey(revision.recipeId, revision.revision), revision);
			if (this.metaTable !== void 0) {
				for (const [id] of this.metaTable.entries()) if (id.trim().length > 0) this.disabled.add(id.trim());
			}
		}
		...
		seedBuiltins() {
			...
			for (const [id, payload] of builtins) if (this.latest(id) === void 0) this.register(id, 1, payload);
		}
		/** Persist one revision write through to the durable store (best-effort). */
		persistRevision(revision) {
			if (this.revisionsTable === void 0) return;
			this.revisionsTable.put(recipeKey(revision.recipeId, revision.revision), revision);
		}
		/** Persist one revision write and settle on durability (CRUD surface). */
		persistRevisionAwaited(revision) {
			if (this.revisionsTable === void 0) return Promise.resolve();
		...
		persistDisabledAwaited(recipeId, disabledAt) {
			if (this.metaTable === void 0) return Promise.resolve();
			return this.metaTable.put(recipeId, {
				recipeId,
				disabledAt
			});
		}
		...
		persistEnabledAwaited(recipeId) {
			if (this.metaTable === void 0) return Promise.resolve();
			return this.metaTable.delete(recipeId).then(() => void 0);
		}
		/** Recipe families shipped with the package; these cannot be deleted. */
		isBuiltin(recipeId) {
			return recipeId === "empty-template" || recipeId === "requirement" || recipeId === "code-review" || recipeId === "bugfix";
		}
		/**
		...
		*/
		async createRecipe(recipeId, payload) {
			...
			if (prior !== void 0 && !this.disabled.has(canonical)) throw new RecipeError("duplicate-revision", `recipe "${canonical}" already exists`);
			const revision = prior === void 0 ? 1 : prior.revision + 1;
		...
		*/
		async deleteRecipe(recipeId) {
			const canonical = recipeId.trim();
			if (canonical.length === 0) throw new RecipeError("invalid-payload", "recipeId must be a non-empty string");
			if (this.isBuiltin(canonical)) throw new RecipeError("invalid-payload", `built-in recipe "${canonical}" cannot be deleted`);
			if (!(this.latest(canonical) !== void 0)) return false;
		...
		*/
		list() {
			return [...this.revisions.values()].filter((revision) => !this.disabled.has(revision.recipeId)).map(({ recipeId, revision }) => ({
				recipeId,
				revision
			}));
		}
...
let TaskHandle = (() => {
	...
	return class TaskHandle extends _classSuper {
		static {
			...
			__esDecorate$14(this, null, _createTask_decorators, {
				kind: "method",
				name: "createTask",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _confirmCreateTask_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _startTask_decorators, {
				kind: "method",
				name: "startTask",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _requestPause_decorators, {
				kind: "method",
				name: "requestPause",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _settlePause_decorators, {
				kind: "method",
				name: "settlePause",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _resume_decorators, {
				kind: "method",
				name: "resume",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _requestCancel_decorators, {
				kind: "method",
				name: "requestCancel",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _settleCancel_decorators, {
				kind: "method",
				name: "settleCancel",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _failTask_decorators, {
				kind: "method",
				name: "failTask",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _completeTask_decorators, {
				kind: "method",
				name: "completeTask",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _markTaskAwaitingDecision_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _resumeTaskFromDecision_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _createTaskRun_decorators, {
				kind: "method",
				name: "createTaskRun",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _createPhaseRun_decorators, {
				kind: "method",
				name: "createPhaseRun",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _startPhaseRun_decorators, {
				kind: "method",
				name: "startPhaseRun",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _recordSubmission_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _requestPatch_decorators, {
				kind: "method",
				name: "requestPatch",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _startGate_decorators, {
				kind: "method",
				name: "startGate",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _recordGateCheck_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _markPhasePassed_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _markPhaseFailed_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _cancelPhaseRun_decorators, {
				kind: "method",
				name: "cancelPhaseRun",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _markPhaseStale_decorators, {
				kind: "method",
				name: "markPhaseStale",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _markPhaseSuperseded_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _markPhaseAwaitingInput_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _markPhaseAwaitingDecision_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _resumePhaseFromAwaiting_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _recordPhaseSession_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _freezePhaseScheduling_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _clearPhaseScheduling_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _markGateChecksStale_decorators, {
				kind: "method",
			...
			__esDecorate$14(this, null, _getTask_decorators, {
				kind: "method",
				name: "getTask",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _listTasks_decorators, {
				kind: "method",
				name: "listTasks",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _getPhaseRun_decorators, {
				kind: "method",
				name: "getPhaseRun",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _listPhaseRuns_decorators, {
				kind: "method",
				name: "listPhaseRuns",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _getSubmission_decorators, {
				kind: "method",
				name: "getSubmission",
				static: false,
				private: false,
			...
			__esDecorate$14(this, null, _listGateResults_decorators, {
				kind: "method",
		...
		constructor(ctx) {
			...
			this.writeTail = (__runInitializers$14(this, _instanceExtraInitializers), Promise.resolve());
...
let WorkbenchJournalService = (() => {
	...
	return class WorkbenchJournalService extends _classSuper {
		static {
			...
			__esDecorate$13(this, null, _append_decorators, {
				kind: "method",
				name: "append",
				static: false,
				private: false,
			...
			__esDecorate$13(this, null, _checkpoint_decorators, {
				kind: "method",
				name: "checkpoint",
				static: false,
				private: false,
			...
			__esDecorate$13(this, null, _replay_decorators, {
				kind: "method",
				name: "replay",
				static: false,
				private: false,
		...
		*/
		constructor(ctx) {
			...
			this.entries = __runInitializers$13(this, _instanceExtraInitializers);
...
let AttentionService = (() => {
	...
	return class AttentionService extends _classSuper {
		static {
			...
			__esDecorate$12(this, null, _createItem_decorators, {
				kind: "method",
				name: "createItem",
				static: false,
				private: false,
			...
			__esDecorate$12(this, null, _listOpen_decorators, {
				kind: "method",
				name: "listOpen",
				static: false,
				private: false,
			...
			__esDecorate$12(this, null, _getItem_decorators, {
				kind: "method",
				name: "getItem",
				static: false,
				private: false,
			...
			__esDecorate$12(this, null, _resolveDecision_decorators, {
				kind: "method",
			...
			__esDecorate$12(this, null, _confirmBatch_decorators, {
				kind: "method",
				name: "confirmBatch",
				static: false,
				private: false,
			...
			__esDecorate$12(this, null, _invalidateItem_decorators, {
				kind: "method",
				name: "invalidateItem",
				static: false,
				private: false,
		...
		*/
		constructor(ctx) {
			super(ctx, "attention");
			this.items = __runInitializers$12(this, _instanceExtraInitializers);
...
let DeliverableService = (() => {
	...
	return class DeliverableService extends _classSuper {
		static {
			...
			__esDecorate$11(this, null, _saveVersion_decorators, {
				kind: "method",
				name: "saveVersion",
				static: false,
				private: false,
			...
			__esDecorate$11(this, null, _listCurrentInputs_decorators, {
				kind: "method",
			...
			__esDecorate$11(this, null, _listVersions_decorators, {
				kind: "method",
				name: "listVersions",
				static: false,
				private: false,
			...
			__esDecorate$11(this, null, _invalidateDownstream_decorators, {
				kind: "method",
		...
		*/
		constructor(ctx) {
			...
			this.versions = __runInitializers$11(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
		}
...
let ReviewPolicyService = (() => {
	...
	return class ReviewPolicyService extends _classSuper {
		static {
			...
			__esDecorate$10(this, null, _setTier_decorators, {
				kind: "method",
				name: "setTier",
				static: false,
				private: false,
			...
			__esDecorate$10(this, null, _getTier_decorators, {
				kind: "method",
				name: "getTier",
				static: false,
				private: false,
			...
			__esDecorate$10(this, null, _defersBatchConfirm_decorators, {
				kind: "method",
			...
			__esDecorate$10(this, null, _applyBreakerDecision_decorators, {
				kind: "method",
		...
		*/
		constructor(ctx) {
			...
			this.tiers = __runInitializers$10(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
...
var RecipeEngineCore = class extends Service {
	...
	async trigger(taskId) {
		...
		const run = (this.tails.get(key) ?? Promise.resolve()).then(() => this.scheduleNow(taskId)).catch((error) => {
			...
			if (this.isDeferrableSchedulingError(error)) {
				this.ctx.logger("recipe-engine").info(`scheduling "${key}" deferred (executor not ready): ${error.message}`);
				return;
			}
			throw error;
		});
	...
	*/
	async executePhase(task, runId, phaseRun, phase, pinned, binding) {
		...
		try {
			...
			if (!this.isDeferrableSchedulingError(error)) await this.ctx.tasks.cancelPhaseRun(phaseKey, this.mutation(task.taskId, phaseRun.revision, "cancel-after-executor-failure"));
	...
	*/
	isDeferrableSchedulingError(error) {
		if (typeof error !== "object" || error === null || !("code" in error)) return false;
		const candidate = error;
		if (candidate.code !== "no-executor" || typeof candidate.message !== "string") return false;
		return candidate.message.startsWith("no executor registered for phase kind") || candidate.message.includes("no phase executor registered");
	}
	/**
...
var RecipeMultiphaseService = class extends Service {
	...
	*/
	registerExecutor(phaseKind, executor) {
		...
		this.ctx.recipeEngine?.retryLive?.();
		return () => {
...
let ClarificationService = (() => {
	...
	return class ClarificationService extends _classSuper {
		static {
			...
			_listOpen_decorators = [Remote("listOpen")];
			__esDecorate$9(this, null, _createRequest_decorators, {
				kind: "method",
				name: "createRequest",
				static: false,
				private: false,
			...
			__esDecorate$9(this, null, _answerPartial_decorators, {
				kind: "method",
				name: "answerPartial",
				static: false,
				private: false,
			...
			__esDecorate$9(this, null, _getRequest_decorators, {
				kind: "method",
				name: "getRequest",
				static: false,
				private: false,
			...
			__esDecorate$9(this, null, _listOpen_decorators, {
				kind: "method",
				name: "listOpen",
				static: false,
				private: false,
		...
		*/
		constructor(ctx) {
			...
			this.requests = __runInitializers$9(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
		}
...
let RewindService = (() => {
	...
	return class RewindService extends _classSuper {
		static {
			...
			__esDecorate$8(this, null, _requestRewind_decorators, {
				kind: "method",
				name: "requestRewind",
				static: false,
				private: false,
			...
			__esDecorate$8(this, null, _applyRewind_decorators, {
				kind: "method",
				name: "applyRewind",
				static: false,
				private: false,
		...
		*/
		constructor(ctx) {
			super(ctx, "rewind");
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = (__runInitializers$8(this, _instanceExtraInitializers), Promise.resolve());
		}
		/**
...
let BudgetService = (() => {
	...
	return class BudgetService extends _classSuper {
		static {
			...
			__esDecorate$7(this, null, _provisionBudget_decorators, {
				kind: "method",
			...
			__esDecorate$7(this, null, _appendBudget_decorators, {
				kind: "method",
				name: "appendBudget",
				static: false,
				private: false,
			...
			__esDecorate$7(this, null, _recordUsage_decorators, {
				kind: "method",
				name: "recordUsage",
				static: false,
				private: false,
			...
			__esDecorate$7(this, null, _getBudget_decorators, {
				kind: "method",
				name: "getBudget",
				static: false,
				private: false,
			...
			__esDecorate$7(this, null, _applyBudgetDecision_decorators, {
				kind: "method",
		...
		*/
		constructor(ctx) {
			super(ctx, "budget");
			this.records = __runInitializers$7(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
		}
...
let DigestService = (() => {
	...
	return class DigestService extends _classSuper {
		static {
			...
			__esDecorate$6(this, null, _digest_decorators, {
				kind: "method",
				name: "digest",
				static: false,
				private: false,
...
let WorkbenchHostService = (() => {
	...
	return class WorkbenchHostService extends _classSuper {
		static {
			...
			_resolveDecision_decorators = [Remote("resolveDecision")];
			_invalidateItem_decorators = [Remote("invalidateItem")];
			__esDecorate$5(this, null, _listSnapshot_decorators, {
				kind: "method",
				name: "listSnapshot",
				static: false,
				private: false,
			...
			__esDecorate$5(this, null, _confirmBatch_decorators, {
				kind: "method",
				name: "confirmBatch",
				static: false,
				private: false,
			...
			__esDecorate$5(this, null, _resolveDecision_decorators, {
				kind: "method",
				name: "resolveDecision",
				static: false,
				private: false,
			...
			__esDecorate$5(this, null, _invalidateItem_decorators, {
				kind: "method",
				name: "invalidateItem",
				static: false,
				private: false,
...
let MetricsService = (() => {
	...
	return class MetricsService extends _classSuper {
		static {
			...
			__esDecorate$4(this, null, _metrics_decorators, {
				kind: "method",
				name: "metrics",
				static: false,
				private: false,
			...
			__esDecorate$4(this, null, _taskMetrics_decorators, {
				kind: "method",
				name: "taskMetrics",
				static: false,
				private: false,
...
let ImpactPropagationService = (() => {
	...
	return class ImpactPropagationService extends _classSuper {
		static {
			...
			__esDecorate$3(this, null, _apply_decorators, {
				kind: "method",
				name: "apply",
				static: false,
				private: false,
...
let EditLockService = (() => {
	...
	return class EditLockService extends _classSuper {
		static {
			...
			__esDecorate$2(this, null, _acquire_decorators, {
				kind: "method",
				name: "acquire",
				static: false,
				private: false,
			...
			__esDecorate$2(this, null, _renew_decorators, {
				kind: "method",
				name: "renew",
				static: false,
				private: false,
			...
			__esDecorate$2(this, null, _release_decorators, {
				kind: "method",
				name: "release",
				static: false,
				private: false,
			...
			__esDecorate$2(this, null, _listActive_decorators, {
				kind: "method",
				name: "listActive",
				static: false,
				private: false,
		...
		*/
		constructor(ctx, config = { sweepIntervalMs: 5e3 }) {
			super(ctx, "editLock");
			this.leases = __runInitializers$2(this, _instanceExtraInitializers);
			/** Serializes read-validate-write mutations so concurrent writers never interleave. */
			this.mutationTail = Promise.resolve();
...
let WorkbenchHostStreamService = (() => {
	...
	return class WorkbenchHostStreamService extends _classSuper {
		static {
			...
			__esDecorate$1(this, null, _listIncremental_decorators, {
				kind: "method",
		...
		constructor(ctx) {
			...
			this.streamId = (__runInitializers$1(this, _instanceExtraInitializers), randomUUID());
		}
		/**
...
//#endregion
//#region lib/types/task-polish/index.js
/**
...
var TaskPolishError = class extends Error {
	constructor(code, message) {
		super(message);
		this.code = code;
	...
	return class TaskPolishService extends _classSuper {
		...
		*/
		async polish(goal) {
			...
			const model = (await this.ctx.llm.listModels(provider))[0]?.id;
			if (model === void 0) throw new TaskPolishError("no-model", `provider "${provider}" discloses no model`);
