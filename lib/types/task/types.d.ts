...
export type TaskState = 'planning' | 'running' | 'awaiting-input' | 'awaiting-decision' | 'pausing' | 'paused' | 'cancelling' | 'cancelled' | 'completed' | 'failed';
/** Durable phase-run lifecycle states. */
export type PhaseRunState = 'created' | 'scheduled' | 'running' | 'submitting' | 'submitted' | 'gate-running' | 'awaiting-input' | 'awaiting-decision' | 'patching' | 'stale' | 'passed' | 'failed' | 'superseded' | 'cancelled';
...
export type TaskErrorCode = 'not-found' | 'stale-revision' | 'invalid-transition' | 'submission-rejected' | 'duplicate-idempotency' | 'invalid-argument';
