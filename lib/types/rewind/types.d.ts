...
export declare const REWIND_OPTIONS: readonly ["confirm-rewind", "keep-current", "cancel"];
...
export type RewindErrorCode = 'not-found' | 'invalid-argument' | 'stale-revision' | 'invalid-transition' | 'not-resolved' | 'invalid-option';
