...
export type ClarificationFactKind = 'clarification/request-created' | 'clarification/answer-recorded' | 'clarification/injected';
...
export declare class ClarificationError extends Error {
