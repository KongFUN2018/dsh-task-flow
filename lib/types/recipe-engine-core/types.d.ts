...
import type { DeliverableVersionRef, PhaseRunId, SubmissionId, TaskId, TaskRunId } from '../task/types.ts';
...
export type RecipeEngineErrorCode = 'no-executor' | 'recipe-unsupported' | 'recovery-mismatch';
/** Engine failure with code and message. */
export declare class RecipeEngineError extends Error {
