...
export class RecipeEngineCore extends Service {
    static { this.inject = ['tasks', 'recipes', 'agents', 'goals', 'storageDomain', 'workbenchJournal']; }
    constructor(ctx) {
    ...
    isDeferrableSchedulingError(error) {
        ...
        if (candidate.code !== 'no-executor' || typeof candidate.message !== 'string')
            return false;
