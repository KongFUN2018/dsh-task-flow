...
export type EditLockErrorCode = 'not-found' | 'invalid-argument' | 'lock-held' | 'invalid-transition';
/** Edit-lock failure with a code and, for lock conflicts, the holder. */
export declare class EditLockError extends Error {
...
export type EditLockFactKind = 'edit-lock/acquired' | 'edit-lock/renewed' | 'edit-lock/released' | 'edit-lock/expired';
